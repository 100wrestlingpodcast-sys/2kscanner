...
async function run() {
  try {
    ...
    console.log("Extracting all columns for new image...");
      ...
      messages: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              text: "Extract the table exactly as it appears. Write down every single column (GRD, PTS, REB, AST, STL, BLK, FOULS, TO, FGM/FGA, 3PM/3PA, TM/FTA) for ALL players in the first team (CriollosDeCaguas) and the second team. Make sure to double check every number.",
            },
            {
              type: "image_url",
              image_url: {
